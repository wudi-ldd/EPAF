...
Here’s the updated section with the addition of the **LoRA** repository link:

## Models and Tools in EPAF

EPAF can be combined with the following models and tools for annotation performance validation, or to further semi-automatically optimize annotation results.
...
### 2. **Interactive Annotation Correction Tool**:
   - **ISAT (Interactive Segmentation Annotation Tool)**:
     ...
     - ISAT is a semi-automatic annotation tool that integrates with the SAM model. It is specifically designed to refine and correct the masks generated by EPAF, providing enhanced precision for post-annotation adjustments.
