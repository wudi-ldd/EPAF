...
### 2. **Interactive Annotation Correction Tool**:
   - **ISAT (Interactive Segmentation Annotation Tool)**:
     ...
     - ISAT is a semi-automatic annotation tool that can be used to refine and correct the masks generated by EPAF, improving the accuracy of the automatic annotation results. 
